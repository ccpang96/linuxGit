...
SECTIONS
{
    ...
    */ 
    ...
    .overlay:
    {
        main_twirl.oer4f (.text:MmwDemo_initTask)
        -llibmailbox_xwr14xx.aer4f (.text:Mailbox_init)
        data_path.oer4f (.text:MmwDemo_edmaInit)
        -llibuart_xwr14xx.aer4f  (.text:UartSci_open)
        -llibmmwave_xwr14xx.aer4f (.text:MMWave_init)
        -llibmmwave_xwr14xx.aer4f (.text:MMWave_initLink)
        -llibcrc_xwr14xx.aer4f  (.text:CRC_initConfigParams)
        -llibcrc_xwr14xx.aer4f  (.text:CRC_open)
        -llibmmwavelink_xwr14xx.aer4f (.text:rlDevicePowerOn)
