...
MSS_MMW_DEMO_SOURCES   = mss_main.c \
						 ...
						 gtrackLog.c \
                         cli.c
MSS_MMW_DEMO_DEPENDS   = $(addprefix  $(PLATFORM_OBJDIR)/, $(MMWAVE_SDK_INSTALL_PATH)/ti/alg/gtrack/, $(MSS_MMW_DEMO_SOURCES:.c=.$(R4F_DEP_EXT)))
...
mssDemo: R4F_CFLAGS += --cmd_file=$(BUILD_CONFIGPKG)/compiler.opt --c99 -d_LITTLE_ENDIAN -i$(MMWAVE_DEMO_DEV_PATH)/radarDemo -i$(MMWAVE_DEMO_DEV_PATH)/api/notarget 
