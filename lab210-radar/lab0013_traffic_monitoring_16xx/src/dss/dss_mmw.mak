...
vpath %.c $(MMWAVE_DEMO_DEV_PATH)/radarDemo/modules/DoA/BF/src
vpath %.c $(MMWAVE_DEMO_DEV_PATH)/radarDemo/modules/DoA/DML/src
vpath %.c $(MMWAVE_DEMO_DEV_PATH)/radarDemo/modules/dopplerProc/dopplerProc/src
...
vpath %.c $(MMWAVE_DEMO_DEV_PATH)/radarDemo/chains/RadarReceiverEDMA_mmwSDK
...
DSS_MMW_DEMO_SOURCES   = dss_main.c \
            ...
            RADARDEMO_dopplerProc.c \
            RADARDEMO_dopplerProc_priv.c \
            RADARDEMO_dopplerProc_utils.c \
...
dssDemo: C674_CFLAGS += --cmd_file=$(BUILD_CONFIGPKG)/compiler.opt -k -os\
