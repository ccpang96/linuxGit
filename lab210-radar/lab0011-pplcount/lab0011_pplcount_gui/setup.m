...
% Last Modified by GUIDE v2.5 26-Feb-2018 06:35:54
...
hUARTPort = findobj('Tag','popupUART');
hDataPort = findobj('Tag','popupData');
...
if(hObject.Value)
     % Get Chirp Config File
     handles.cfg.filename = 'mmw_pcdemo_default.cfg';
     guidata(hObject,handles)
end
