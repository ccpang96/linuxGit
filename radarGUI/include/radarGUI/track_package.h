...
/**
 * @brief The TempPoint class
 * 说明：临时点迹数据
 * 存储航迹起始和点迹航迹关联时没有用到的点迹
 */
class TempPointPackage {
public:
    /**
     * @brief temp_point_
     * 说明：
...
/**
 * @brief The TrustTrack class
 * 说明：可靠航迹数据
 * 存储已经形成的可靠航迹的信息，保存的每条可靠航迹的最后一个点的信息
 */
class TrustTrackPackage {
public:
    /**
     * @brief trust_track_
     * 说明：
     ...
     * 2.航迹消亡的未被更新次数门限值
     */
    Eigen::Vector4d last_point_x_;  //最后一个点的状态变量信息
...
/**
 * @brief The TrackDataOutput class
